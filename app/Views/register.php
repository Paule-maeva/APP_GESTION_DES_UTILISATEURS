...
<div class="grid grid-cols-1 md:grid-cols-2 bg-white shadow-lg rounded-lg max-w-3xl w-full">
    ...
    <img class="w-full h-full object-cover rounded-l-lg" src="assets/img/6333204.jpg" alt="Illustration">
    </div>
    ...
    <div class="flex flex-col justify-center px-6 py-12">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <!-- Formulaire -->
            <form class="space-y-6" action="index.php?action=register_process" method="POST">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" id="password" required class="top-2/3 block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 focus:ring-indigo-600 focus:border-indigo-600">
                    <button type="button" onclick="togglePassword()" class="absolute right-3 top-9 transform -translate-y-1/2 text-gray-500">
            ...
            <p class="mt-6 text-center text-sm text-gray-600">
                ...
                <a href="index.php?action=login" class="text-indigo-600 hover:text-indigo-500 font-semibold">Se connecter</a>
